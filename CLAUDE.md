...
### Tests
- `venv\Scripts\python.exe -m unittest discover tests` - stdlib `unittest`, no extra dependencies (pytest isn't installed). Covers backup, restore, pre-update backup and the Excel export.
